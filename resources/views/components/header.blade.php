<header class="flex justify-between items-center bg-[#455bd4] text-white px-8 py-3">
    <div class="flex flex-col cursor-pointer w-[40px] relative group" id="toggle-menu">
      <input type="checkbox" class="peer absolute z-10 opacity-0 w-[33px] h-[33px]">
      <span
    ...
    <div class="w-[60%]">
      <h2 class="text-lg font-semibold text-[25px]">Selamat Datang, <span id="nama-perusahaan">[nama perusahaan]</span>
      </h2>
    ...
    <div class="flex items-center gap-3">
      <div>
        <h4 class="font-semibold text-[18px]">Nama Perusahaan</h4>
